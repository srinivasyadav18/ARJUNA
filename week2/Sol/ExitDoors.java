/*
 * 
 A king’s palace has special rooms that form a 2D grid. 
...
● First line 4 represents total number of cols
● Next four lines represents the grid (G).
● Values in each separated by a space
Explanation:
● There are Exit Points at G(1,3) and G(4,1)
● For the gold room at G(1,1), it takes 4 steps
...
output.
● For the gold room at G(4,4), it takes 7 steps
